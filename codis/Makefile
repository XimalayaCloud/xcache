...
build-all: codis-server codis-dashboard codis-proxy codis-admin codis-ha codis-fe zk-to-mysql clean-gotest
...
zk-to-mysql: codis-deps
	go build -i -o bin/zk-to-mysql ./cmd/zktomysql
