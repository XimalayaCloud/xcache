 ...
 * key type
 */
#define PIKA_KEY_TYPE_KV    'k'
#define PIKA_KEY_TYPE_HASH  'h'
#define PIKA_KEY_TYPE_LIST  'l'
#define PIKA_KEY_TYPE_SET   's'
#define PIKA_KEY_TYPE_ZSET  'z'

/*
 * cache status
 */
#define PIKA_CACHE_STATUS_NONE      0
#define PIKA_CACHE_STATUS_INIT      1
#define PIKA_CACHE_STATUS_OK        2
#define PIKA_CACHE_STATUS_RESET     3
#define PIKA_CACHE_STATUS_DESTROY   4
#define PIKA_CACHE_STATUS_CLEAR     5
