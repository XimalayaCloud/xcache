...
const std::string kCmdNameSlotsDelOff = "slotsdeloff";
...
//Ehash
const std::string kCmdNameEhset = "ehset";
const std::string kCmdNameEhsetnx = "ehsetnx";
const std::string kCmdNameEhsetex = "ehsetex";
const std::string kCmdNameEhexpire = "ehexpire";
const std::string kCmdNameEhexpireat = "ehexpireat";
const std::string kCmdNameEhttl = "ehttl";
const std::string kCmdNameEhpersist = "ehpersist";
const std::string kCmdNameEhget = "ehget";
const std::string kCmdNameEhexists = "ehexists";
const std::string kCmdNameEhdel = "ehdel";
const std::string kCmdNameEhlen = "ehlen";
const std::string kCmdNameEhstrlen = "ehstrlen";
const std::string kCmdNameEhincrby = "ehincrby";
const std::string kCmdNameEhincrbyfloat = "ehincrbyfloat";
const std::string kCmdNameEhmset = "ehmset";
const std::string kCmdNameEhmsetex = "ehmsetex";
const std::string kCmdNameEhmget = "ehmget";
const std::string kCmdNameEhkeys = "ehkeys";
const std::string kCmdNameEhvals = "ehvals";
const std::string kCmdNameEhgetall = "ehgetall";
...
public:
  ...
  bool need_write_cache() const {
    return ((flag_ & kCmdFlagsMaskPostDo) == kCmdFlagsPostDo);
  }
